...
@media (max-width: 640px) { .radio-page { gap: 18px; }.radio-hero { min-height: auto; border-radius: 20px; padding: 24px 18px; }.radio-hero h1 { font-size: clamp(32px,10vw,44px); white-space: normal; }.radio-live-line { margin-bottom: 20px; }.radio-now-meta { grid-template-columns: 1fr; }.radio-console { padding: 13px; transform: none; }.radio-display { min-height: 130px; }.radio-console__hardware { grid-template-columns: 1fr 76px; min-height: 90px; }.radio-knob { width: 58px; height: 58px; }.radio-section-heading { display: grid; grid-template-columns: minmax(0,1fr) auto; align-items: start; gap: 12px; }.radio-section-heading h2 { max-width: 9em; font-size: clamp(23px,6.7vw,26px); line-height: 1.15; text-wrap: balance; }.radio-refresh { min-width: max-content; padding: 0 4px; white-space: nowrap; }.radio-refresh span { margin-right: 3px; }.radio-tuner { grid-template-columns: 1fr; padding: 14px; border-radius: 14px; }.radio-tuner__knob { display: none; }.radio-tuner__numbers span:nth-child(even) { display: none; }.radio-tuner__caption { grid-template-columns: auto 1fr; }.radio-tuner__caption small { display: none; }.radio-theme-cloud { grid-template-columns: repeat(2,minmax(0,1fr)); gap: 8px; padding: 6px 0; }.radio-theme,.radio-theme:nth-child(n) { grid-template-columns: 36px minmax(0,1fr); min-height: 50px; padding: 6px 10px 6px 7px; transform: none; }.radio-theme__icon { width: 36px; height: 36px; }.radio-dj-controls { grid-template-columns: 1fr; }.radio-create-stage { grid-template-columns: 1fr; border-radius: 22px; padding: 22px 18px; }.radio-create-visual { width: 138px; }.radio-generate { grid-column: auto; grid-template-columns: auto 1fr auto; padding-right: 14px; }.radio-generate__wave { width: 46px; height: 46px; } }
`
